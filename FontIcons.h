...
public:
    static FontIcons& Instance();

    QChar getIconChar(FontIcons::IconCode code);
...
protected:
    ...
    FontIcons(const FontIcons& fai) = delete;

    FontIcons& operator=(const FontIcons& fai) = delete;
